...
class GunshotMultipleList(APIView):
    ...
    """
    def get(self, request, format=None):
        gs = GsReportFunnelMultiple.objects.all()
        serializer = GsReportFunnelMultipleSerializer(gs, many=True)
        return Response(serializer.data)
